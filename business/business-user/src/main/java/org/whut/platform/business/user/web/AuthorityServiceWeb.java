...
public class AuthorityServiceWeb {
    ...
    public String update(@FormParam("jsonString") String jsonString){
        ...
        String authorityDescription = Authority.getDescription();
        int  authorityStatus = Authority.getStatus();
        String resource = Authority.getResource();
        Authority authority = new Authority();
    ...
    public String list(){
        ...
        List<Authority> listNew =new ArrayList<Authority>();
        ...
        for(Authority a:list){
            ...
            Authority.setStatus(a.getStatus());
            ...
            Authority.setResource(r1);
            listNew.add(Authority);
        }
